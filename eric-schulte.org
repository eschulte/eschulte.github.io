...
the jobs of software developers from the mundane ([[https://mergeresolver.github.io][merge resolver]]) to
the creative (the [[https://grammatech.gitlab.io/Mnemosyne/docs/][mnemosyne]] program synthesis framework).
